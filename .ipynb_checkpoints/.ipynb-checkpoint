 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "DATA_PATH = \"/home/ec2-user/SageMaker/project/data/\"\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "df001 = load_data(DS_FILENAME.format('train', '1'))\n",
    "df002 = load_data(DS_FILENAME.format('train', '2'))\n"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "ENGINE_NUMBER          53759.0   131.082981   74.463862     1.0000    68.0000   \n",
       "TIME_IN_CYCLES         53759.0   109.154746   69.180569     1.0000    52.0000   \n",
       ...
       "\n",
       "                             50%        75%        max  \n",
       "ENGINE_NUMBER           131.0000   195.0000   260.0000  \n",
       "TIME_IN_CYCLES          104.0000   157.0000   378.0000  \n",
